...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      {
        image: `/img/ensaladas/ensalada-1.webp`,
        text: 'Caesar',
        price: '$85'
      },
      {
        image: `/img/ensaladas/ensalada-2.webp`,
        text: 'Griega',
        price: '$95'
      },
      {
        image: `/img/ensaladas/ensalada-3.webp`,
        text: 'Caprese',
        price: '$90'
      },
      {
        image: `/img/ensaladas/ensalada-4.webp`,
        text: 'Mixta',
        price: '$80'
      }
    ];
...
export default function SaladGallery({
  items,
  bend = 3,
  textColor = '#ffffff',
  borderRadius = 0.05,
