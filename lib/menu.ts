...
export const menuItems: MenuItem[] = [
...

  {
    ...
    options: [
      {
        id: "atumanera-principal",
        title: "Elige tu plato principal",
        type: "single",
        required: true,
        items: [
          { id: "royale-papas", label: "Royale Burger con Papas" },
          { id: "majestic-papas", label: "Majestic Bacon Burger con Papas" },
          { id: "pizza-peperonisima", label: "Pizza Cheese Crust Peperonísima" },
        ],
      },
      {
        id: "atumanera-juzzy",
        title: "Elige tu JUZZY",
        type: "single",
        required: true,
        items: [
          { id: "bebida-honey-limonada", label: "Juzzy Honey Limonada" },
          { id: "bebida-jazmin-soda", label: "Juzzy Honey Soda" },
          { id: "bebida-frutos-rojos", label: "Juzzy Frutos Rojos" },
          { id: "bebida-naranja-miel-y-jazmin", label: "Juzzy Naranja Miel y Jazmín" },
          { id: "bebida-maracuya-naranja", label: "Juzzy Maracuyá Naranja" },
        ],
      },
      {
        id: "atumanera-coolkie",
        title: "Elige tu COOLKIE",
        type: "single",
        required: true,
        items: [
  ...
  },
  {
    ...
    options: [
      {
        id: "match-boneless-salsa",
        title: "Salsa de tu Boneless",
        type: "single",
        required: true,
        items: [
          { id: "buffalo-classic", label: "Buffalo Classic" },
          { id: "jack-bbq-smoke", label: "Jack BBQ Smoke" },
          { id: "buffaranch", label: "BuffaRanch" },
          { id: "hot-honey", label: "Hot Honey" },
          { id: "truffalo-supreme", label: "Truffalo Supreme" },
          { id: "korean-crunch", label: "Korean Crunch" },
        ],
      },
      {
        id: "match-juzzy-1",
        title: "Elige tu JUZZY #1",
        type: "single",
        required: true,
        items: [
          { id: "bebida-honey-limonada", label: "Juzzy Honey Limonada" },
  ...
  },
  {
    ...
    options: [
      {
        id: "entre-amigos-boneless-salsa",
        title: "Salsa de tu Boneless",
        type: "single",
        required: true,
        items: [
      ...
      {
        id: "entre-amigos-juzzy-3",
        title: "Elige tu JUZZY #3",
        type: "single",
        required: true,
        items: [
          { id: "bebida-honey-limonada", label: "Juzzy Honey Limonada" },
      ...
      {
        id: "entre-amigos-juzzy-4",
        title: "Elige tu JUZZY #4",
        type: "single",
        required: true,
        items: [
          { id: "bebida-honey-limonada", label: "Juzzy Honey Limonada" },
      ...
      {
        id: "entre-amigos-rooky-1",
        title: "Elige tu ROOKY #1",
        type: "single",
        required: true,
        items: [
          { id: "bebida-rooky-fresas", label: "Rooky Fresas con Crema" },
          { id: "bebida-rooky-cajeta", label: "Rooky Honey Cajeta" },
          { id: "bebida-rooky-matcha-azul", label: "Rooky Matcha Azul" },
          { id: "bebida-rooky-chocoreta", label: "Rooky Chocoreta" },
          { id: "bebida-rooky-nutella", label: "Rooky Nutella" },
        ],
      },
      {
        id: "entre-amigos-rooky-2",
        title: "Elige tu ROOKY #2",
        type: "single",
        required: true,
        items: [
          { id: "bebida-rooky-fresas", label: "Rooky Fresas con Crema" },
      ...
      {
        id: "entre-amigos-rooky-3",
        title: "Elige tu ROOKY #3",
        type: "single",
        required: true,
        items: [
          { id: "bebida-rooky-fresas", label: "Rooky Fresas con Crema" },
      ...
      {
        id: "entre-amigos-rooky-4",
        title: "Elige tu ROOKY #4",
        type: "single",
        required: true,
        items: [
          { id: "bebida-rooky-fresas", label: "Rooky Fresas con Crema" },
